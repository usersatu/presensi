...
class PresensiController extends Controller
{
         ...
         echo "error|Maaf Anda Berada Diluar Radius, Jarak Anda ".$radius." meter dari Kantor|";
            ...
            if($cek > 0){
               ...
               if ($update) {
                  ...
                  echo "error|Maaf Gagal Apsen, Silakan Hubungi Tim IT|out";
            }
            }else {
               $data = ([
                  'nik' => $nik,
               ...
               if ($simpan) {
                  ...
                  Storage::put($file, $image_base64);
                        ...
                        echo "error|Maaf Gagal Apsen, Silakan Hubungi Tim IT|in";
                  }
            }
         }
   ...
   public function approvedizinsakit(Request $rekap)
   {
      $status_approved = $rekap->status_approved;
      $id_izinsakit_form =$rekap->id_izinsakit_form;
