<form method="POST" action="/departemen/{{ $departemen->kode_dept }}/update" id="frmDepartemen">
            @csrf
            <div class="row">
                <div class="col-12">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="input-icon mb-3">
                        ...
                        <input type="text" value="{{ $departemen->nama_dept }}" id="nik" class="form-control" name="nama_dept" placeholder="Nama Departemen" >
                      </div>
                </div>
            </div>
            <div class="row mt-2">
