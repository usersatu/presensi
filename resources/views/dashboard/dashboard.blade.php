            ...
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 16px 12px !important">
                        ...
                        <br>
                        <span style="font-size: 0.8rem; font-weinght:500">Izin</span>
                    </div>
                </div>
            </div>
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 16px 12px !important">
                        ...
                        <br>
                        <span style="font-size: 0.8rem; font-weinght:500">Sakit</span>
                    </div>
                </div>
            </div>
            <div class="col-3">
                <div class="card">
                    <div class="card-body text-center" style="padding: 16px 12px !important">
                        ...
                        <br>
                        <span style="font-size: 0.8rem; font-weinght:500">Telat</span>
                    </div>
                </div>
            </div>
